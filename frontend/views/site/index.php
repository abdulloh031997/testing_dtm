                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">DTM</span> Ilmiy-o'quv amaliy markazida</h1>
                            <p class="p-large">Oliy talim mussalariga kirish imtixonidan oldin O'zingizni tekshirib ko'ring. </p>
                            <a class="btn-solid-lg page-scroll" href="#services">Ro'yxatdan o'ting</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading p-large">Biz bilan imtixonga ajoyib tayorgarlik</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Test O'tkazish</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Test Taxlili</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Malaka oshirish</h4>
    ...
    <div class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Biz bilan online testlar qatnashing </h2>
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Biz sizning testlaringizni taxlili va sizning imkoniyatlaringizni baxolab beramiz</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Boshlang'ich</div>
                            <div class="card-subtitle">1-4</div>
                            <hr class="cell-divide-hr">
                            <div class="price">
                                <span class="currency"></span><span class="value">10 000 </span>
                            ...
                            <ul class="list-unstyled li-space-lg">
                                ...
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Ona tili</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Ingliz tili</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Rus tili</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">.........</div>
                                </li>
                            </ul>
                            <div class="button-wrapper">
                                <a class="btn-solid-reg page-scroll" href="#request">Kirish</a>
                            </div>
                        </div>
                    </div> <!-- end of card -->
                    <!-- end of card -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">O'rta daraja</div>
                            <div class="card-subtitle">5-9</div>
                            <hr class="cell-divide-hr">
                            <div class="price">
                                <span class="currency"></span><span class="value">15 000</span>
                                <div class="frequency">so'm 1 yilga</div>
                            </div>
                            <hr class="cell-divide-hr">
                            <ul class="list-unstyled li-space-lg">
                                ...
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Fizika</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Tarix</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Ingliz tili</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Ona tili va Adabiyot</div>
                                </li>
                            </ul>
                            <div class="button-wrapper">
                                <a class="btn-solid-reg page-scroll" href="#request">Kirish</a>
                    ...
                    <div class="card">
                        <div class="label">
                            <p class="best-value">Yangi testlar</p>
                        </div>
                        <div class="card-body">
                            <div class="card-title">Abiturentlar</div>
