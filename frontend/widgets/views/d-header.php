...
<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        <div class="navbar-logo" logo-theme="theme4" style="background-color: #0da5e8;">
            <a class="mobile-menu" id="mobile-collapse" href="#!">
                <i class="feather icon-menu"></i>
            </a>
            <a href="" style="font-family: sans-serif; font-weight: bold;">
                <!-- <img class="img-fluid" src="..\images\t.png" style="background-color: #fff;" alt="Theme-Logo"> -->
                Ilmiy-markaz 
            </a>
